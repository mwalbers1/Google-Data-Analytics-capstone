...
-- DROP TABLE IF EXISTS public."HOURLY_ACTIVITY";
...
(
  ...
  ALTER TABLE IF EXISTS public."HOURLY_ACTIVITY"
      OWNER to postgres;

-- DROP TABLE IF EXISTS public."HOURLY_SEDENTARY";

CREATE TABLE IF NOT EXISTS public."HOURLY_SEDENTARY"
(
    "ID" bigint,
    "ACTIVITY_HOUR" timestamp,
    "SEDENTARY_ACTIVITY" integer
)
TABLESPACE pg_default;

ALTER TABLE IF EXISTS public."HOURLY_SEDENTARY"
    OWNER to postgres;
